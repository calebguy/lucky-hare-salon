...
export default function Home() {
	return (
		<div className="flex min-h-screen flex-col items-center bg-sage px-6 [&:has(a:hover)_svg]:text-brown">
			...
			<div className="flex flex-1 items-center justify-center">
				<a
					...
					className="inline-block rounded bg-light-blue px-8 py-3 text-center font-dreamboat-thin text-base uppercase tracking-widest text-sage transition-colors duration-300 hover:bg-brown md:px-10 md:py-4 md:text-lg"
				>
					Book an appointment
				</a>
			</div>
